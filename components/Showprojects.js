   ...
   <>
     {userPosts && (
        <div class="flex justify-around w-full">
            <div class="overflow-scroll w-[80vw] bg-slate-300 overflow-scroll h-[80vh]">
                
                { userPosts.map((userPost,i) => (
                    
                <div class="flex bg-white shadow-sm rounded-lg mx-4 md:mt-6 md:mx-auto w-[80%] ">
                    <div class="flex items-start px-4 py-6">
                    <img class="w-12 h-12 rounded-full object-cover mr-4 shadow" src={userPost.post.avatar} alt="avatar">
                    </img>
                    <div class="">
                            <div class="flex items-center justify-between">
                                <h2 class="text-lg font-semibold text-gray-900 -mt-1">{userPost.post.title}</h2>
                            ...
                            <div class="mt-6">
                                { userPost.comments &&  (userPost.comments.map((comment,i) => (
