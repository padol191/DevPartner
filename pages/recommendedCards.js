...
{ cards.map((card,i) => (
			...
			<div class="flex flex-col items-center justify-center bg-white p-4 shadow rounded-lg">
				...
				<div className='flex'>
				<button className="mx-2 px-6 my-2 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white py-2 text-xs">Connect</button>
				<button className="mx-2 px-8 my-2 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white py-2 text-xs">View</button>
				</div>
			</div>
